      ...
      <section className="subpage-hero">
        <div className="shell">
          ...
          <p>
            ...
            still giving groups a separate place to collaborate.
          </p>
        </div>
      </section>
      ...
      <section className="section about-page">
        <div className="shell about-intro">
          ...
          <div>
            ...
            <p>
              The main study hall offers 47 study desks for reading, exam
              preparation, remote work and long focus sessions. The environment
              is designed around reliable internet, access to power, lockers and
              a long daily opening window.
            </p>
          </div>
        </div>
        ...
        <div className="shell about-feature-grid">
          <article>
            ...
            <strong>47 study desks</strong>

            <p>Individual spaces for productive and uninterrupted study.</p>
          </article>
          ...
          <article>
            ...
            <p>Useful for online learning, research and remote work.</p>
          </article>

          <article>
            <Clock3 size={23} />

            <strong>7 AM – 9 PM</strong>

            <p>A study schedule from morning through evening.</p>
          </article>

          <article>
            <MapPin size={23} />

            <strong>Samakhusi</strong>

            <p>Located at Jaldhara Marg, Kathmandu.</p>
          </article>
        </div>
      </section>
