...
const features = [
  ...
  },
  {
    ...
    text: "Comfortable individual desks designed for laptops and long sessions.",
  },
  {
    icon: Clock3,
        ...
        <div className="shell home-hero-layout">
          ...
          >
            ...
            >
              ...
              >
                Designed for students, exam preparation, reading, remote work
                and long uninterrupted focus sessions.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="shell discussion-banner">
          ...
          <div>
            ...
            <p>
              ...
              discussions while keeping the main study hall peaceful.
            </p>
          </div>
      ...
      <section className="section home-plans">
        <div className="shell">
          <div className="section-heading">
            ...
            <p>
              Simple plans for short-term exam preparation, monthly routines and
              long-term study consistency.
            </p>
          </div>
